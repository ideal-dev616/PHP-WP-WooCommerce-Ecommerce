...
switch ( $onclick ) {
	...
	case 'link_image':
        ...
        if ( $post_ID = get_the_ID() ) {
            ...
            update_post_meta( $post_ID, '_post_scripts', array_unique( array_merge( ['prettyphoto'], $post_scripts ) ) );
        }
	...
	case 'zoom':
        ...
        if ( $post_ID = get_the_ID() ) {
            ...
            update_post_meta( $post_ID, '_post_scripts', array_unique( array_merge( ['vc_image_zoom'], $post_scripts ) ) );
        }
