...
<?php if ( bbp_current_user_can_access_anonymous_user_form() ) : ?>
	...
	<fieldset class="bbp-form">
		<legend><?php ( bbp_is_topic_edit() || bbp_is_reply_edit() ) ? esc_html_e( 'Author Information', 'ave' ) : esc_html_e( 'Your information:', 'ave' ); ?></legend>

		<?php do_action( 'bbp_theme_anonymous_form_extras_top' ); ?>

		<p>
			<label for="bbp_anonymous_author"><?php esc_html_e( 'Name (required):', 'ave' ); ?></label><br />
		...
		<p>
			<label for="bbp_anonymous_email"><?php esc_html_e( 'Mail (will not be published) (required):', 'ave' ); ?></label><br />
		...
		<p>
			<label for="bbp_anonymous_website"><?php esc_html_e( 'Website:', 'ave' ); ?></label><br />
